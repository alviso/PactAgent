...
var D3LineBasic = function() {
    ...
    var _assetValue = function() {
        ...
        // Main variables
        var element = document.getElementById('assetValue'),
            height = 400;
        ...
        if(element) {
            ...
            var d3Container = d3.select(element),
                margin = {top: 5, right: 60, bottom: 30, left: 60},
            ...
            // Load data
            // ------------------------------
            d3.json("/ajax/assetValue", function(error, data) {
    ...
    var _priceHistory = function() {
        ...
        // Main variables
        var element = document.getElementById('priceHistory'),
            height = 400;
        ...
        if(element) {
            ...
            // Load data
            // ------------------------------
            d3.json("/ajax/priceHistory", function(error, data) {
