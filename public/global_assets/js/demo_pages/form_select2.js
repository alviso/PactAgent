    ...
    var _componentSelect2 = function() {
        ...
        function formatRepo (repo) {
            ...
            var markup = '<div class="select2-result-repository clearfix">' +
                '<div class="select2-result-repository__avatar"><img src="' + repo.prodImgUrl + '" /></div>' +   //
                '<div class="select2-result-repository__meta">' +
                '<div class="select2-result-repository__title">' + repo.name + '</div>';

            if (repo.price) {
                markup += '<div class="select2-result-repository__description">' + repo.price + ' USD</div>';
            }
        ...
        function formatRepoSelection (repo) {
            $('#unitPrice').val(repo.price)
            $('#prodImgUrl').val(repo.prodImgUrl)
        ...
        $('.select-remote-data').select2({
            ajax: {
                url: '/ajax/products', //'https://api.github.com/search/repositories',
                dataType: 'json',
                delay: 250,
